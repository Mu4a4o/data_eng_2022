...
-- 4. Получмте номера билетов, классов обслуживания и статус рейсов только тех самолетов,
-- которые вылетали в первом полугодии 2017 г. (ticket_flights,flights)

-- 5. Получите  идентификатор всех рейсов ticket_flights,с джойном индетификаторрм рейсов из flights

-- 6. Получите  идентификатор всех рейсов flights,с джойном индетификаторрм рейсов из ticket_flights


-- 7. Получите  идентификатор рейсов которые есть только в ticket_flights и в flights
